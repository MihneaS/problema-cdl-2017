...
DDEESSCCRRIIPPTTIIOONN
       ...
       FILES  are  `FILE1  FILE2'  or `DIR1 DIR2' or `DIR FILE...' or `FILE... DIR'.  If ----ffrroomm--ffiillee or ----ttoo--ffiillee is given, there are no restrictions on FILE(s).  If a FILE is
       `-', read standard input.  Exit status is 0 if inputs are the same, 1 if different, 2 if trouble.
...
SSEEEE AALLSSOO
       ...
       The full documentation for ddiiffff is maintained as a Texinfo manual.  If the iinnffoo and ddiiffff programs are properly installed at your site, the command
